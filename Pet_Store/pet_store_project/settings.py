"""
Django settings for pet_store_project project.
...
SECRET_KEY = '*zue!xa8!4r-z@i%5_3%oo8pbi$fs3_t1^neh)8*=6@n0ryypy'
...
ROOT_URLCONF = 'pet_store_project.urls'
...
WSGI_APPLICATION = 'pet_store_project.wsgi.application'
